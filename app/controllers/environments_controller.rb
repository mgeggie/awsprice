class EnvironmentsController < ApplicationController
  ...
  def index
    ...
    @total_outbound_bandwidth = 0.0
    @environments.each do |environment|
      @total_hourly_cost += environment.hourly_cost
      @total_upfront_cost += environment.upfront_cost
      @total_monthly_cost += environment.monthly_cost
      @total_outbound_bandwidth += environment.outbound_bandwidth
    end
  ...
  def show
    ...
    @environment_nodes = @environment.environment_nodes
